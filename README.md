...
1. Sigue esta secuencia exacta de comandos en tu terminal para descargar exclusivamente la carpeta de trabajo asignada:
    ...
    # 1. Clonar el repositorio sin descargar archivos completos
      git clone --no-checkout [https://github.com/CococysLabs/777_Organizacion-Lenguajes-y-Compiladores-1.git (https://github.com/CococysLabs/777_Organizacion-Lenguajes-y-Compiladores-1.git)

    cd 777_Organizacion-Lenguajes-y-Compiladores-1
